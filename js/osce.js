(function () {
    ...
    const SKILL_TO_TEXT = {
        '상처관리': '상처의 길이와 깊이를 확인하며 적절한 봉합 방법을 선택한다. 멸균을 유지하고 안전하게 시행한다.',
        '응급처치': '응급 상황을 신속히 평가하고, 기도-호흡-순환을 순서대로 확인한다. 필요한 경우 즉시 적절한 처치를 시행한다.',
        '동맥혈 채혈 및 안전수혈술기': '적절한 무균 술기를 유지하며 동맥혈 채혈을 시행하고, 수혈 전 환자 확인과 검체 식별을 확실히 한다.',
        '혈액배양 채혈 및 안전수혈술기': '혈액배양 채혈 전 소독을 철저히 하고 오염을 최소화하며, 라벨링 및 운반 절차를 준수한다.'
    };
